<div class="{{ $col_md }} col-sm-6 col-xs-12">
  <div class="shop-item text-center">
    ...
    <div class="shop-desc">
      ...
      <small class="regular">{{ $item->category->name }}</small>
    </div><!-- end shop-desc -->

    <div class="shop-meta clearfix">
      <ul class="">
        <li><a href="{{ url('producto/'.$item->slug) }}"><i class="fa fa-search"></i> Ver más</a></li>
        <li><a href="{{ url('process/comprar-ahora/'.$item->slug) }}"><i class="fa fa-money"></i> Comprar</a></li>
        <li><a href="{{ url('process/add-cart-item/'.$item->id) }}"><i class="fa fa-cart-plus"></i> Agregar</a></li>
      </ul><!-- end list -->
    </div><!-- end shop-meta --> 
  </div><!-- end shop-item -->
</div><!-- end col -->